...
\item
	...
	\ressubheading{MCON China Ltd.}{Beijing, People's Republic of China}{Engineering Team Leader // Systems Engineer}{August 2011 - August 2014}
	\linebreak
	\linebreak
	...
	\begin{itemize}
			...
			\resitem{Managed a multi-national team of 5 individuals to perform daily maintenance tasks of infrastructure, support a development team of \url{~}100 individuals for their daily IT needs, and perform consulting duties with out automotive customers around Beijing.}
...
\begin{itemize}
	...
	\item
		\ressubheading{Volkswagen Group China - NADIN Migration}{Beijing, People's Republic of China}{Project Manager}{April 2014 - August 2014}
		\linebreak
		\linebreak
		...
		\begin{itemize}
			...
			\resitem{Coordinated with Volkswagen Germany's NADIN support team for upgrade scheduling, scope of support, and acted as a liason for technical questions raised by Volkswagen Group China.}
		\end{itemize}
...
\item {\bf Programming Languages:} BASH / Shell (preferred), PHP, SQL, Apache ANT, \LaTeX

\item {\bf Spoken Languages:} English (native), Mandarin Chinese (working proficiency)

\item {\bf Technical Software}
	\begin{itemize}
		\resitem{Server:} Linux (all flavors), Apache, NGINX, Puppet, Tomcat
		\resitem{Database:} MySQL, SQLite3, MongoDB
		\resitem{Management:} Puppet, RedHat Cluster Administration
