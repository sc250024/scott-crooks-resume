...
\item
	...
	\linebreak
	\linebreak
	Volkswagen Group China (VGC) MS/2 Project for deploying CDN servers to each of China's Volkswagen brand dealerships. Dealers would receive content pushed to their dealership's CDN server in order to locally stream training videos.
	\begin{itemize}
...
\item
	...
	\begin{itemize}
		...
		\resitem{Wrote monitoring plugins in BASH & Python to tailor to VGC's specific monitoring needs.}
	\end{itemize}
...
\item {\bf Technical Software:} Linux, Git / SVN
	\begin{itemize}
		\resitem{Test}
		\resitem{Test2}
	\end{itemize}

\item {\bf Creative Software:} Adobe Illustrator, Adobe Photoshop
	\resitem{Test2}
